...
-- Project Reference: tkkonrkwsuoigrysewgk

-- pg_cron extension'ını etkinleştir
CREATE EXTENSION IF NOT EXISTS pg_cron;

-- Mevcut günlük rapor görevini sil (varsa - hata verirse yoksay)
DO $$
BEGIN
...
-- NOTLAR:
-- 1. Project Reference ID zaten eklendi: tkkonrkwsuoigrysewgk
